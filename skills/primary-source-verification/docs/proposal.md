...
- **Q5 — Relation to csr.** Additive, non-merging. psv runs after or beside csr; csr's `substantive_converged` does not imply psv's coverage, and psv's coverage does not grant csr's process convergence.
