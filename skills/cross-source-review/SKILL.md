...
python3 skills/cross-source-review/infra/test/csr_progress_gates.py     # run-progress sidecar: registry sync, append shape, status render, wrapper tee + best-effort (ADR #61)
